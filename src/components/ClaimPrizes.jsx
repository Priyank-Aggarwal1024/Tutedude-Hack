        ...
        <section className="claim-prizes">
            ...
            <div className="sun">
                <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 80 80" fill="none">
                    <g clipPath="url(#clip0_561_1955)">
                        <path d="M31.7238 10.5098L36.9372 29.9663M60.6415 3.15233L44.6531 30.845M49.2721 37.0879L68.7286 31.8745M76.0861 60.7922L48.3934 44.8038M42.1505 49.4228L47.3639 68.8793M18.4462 76.2368L34.4346 48.5441M10.3591 47.5146L29.8156 42.3012M3.00162 18.5969L30.6943 34.5853" stroke="#800080" strokeOpacity="0.87" strokeWidth="2" />
                    </g>
                    <defs>
                        <clipPath id="clip0_561_1955">
                            <rect width="64.4571" height="64.4571" fill="white" transform="translate(0.0703125 16.9053) rotate(-15)" />
                        </clipPath>
                    </defs>
                </svg>
            </div>
            <div className="star1">
                <svg xmlns="http://www.w3.org/2000/svg" width="46" height="46" viewBox="0 0 46 46" fill="none">
                    <path d="M45.0542 19.2017C30.253 21.6362 21.6352 15.4529 19.2007 0.651818C21.6352 15.4529 15.4519 24.0708 0.650823 26.5053C15.4519 24.0708 24.0698 30.2541 26.5043 45.0552C24.0698 30.254 30.253 21.6362 45.0542 19.2017Z" stroke="#800080" strokeOpacity="0.87" strokeWidth="1.67308" />
                </svg>
            </div>
            <div className="star2">
                <svg xmlns="http://www.w3.org/2000/svg" width="46" height="46" viewBox="0 0 46 46" fill="none">
            ...
            <div className="claim-bottom">
                <div className="claim-reserve button-animation-parent">
